...
|---|---|---|---|
| `web_search` | builtin | [x] | DuckDuckGo HTML scrape, no key |
| `http_fetch` | builtin | [x] | Fetches a page, returns truncated body |
| `crtsh_lookup` | http | [x] | Certificate-transparency log via crt.sh |
| `whois_dns` | http | [x] | hackertarget WHOIS + DNS, no key |
